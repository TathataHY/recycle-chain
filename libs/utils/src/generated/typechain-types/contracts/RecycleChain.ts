...
export interface RecycleChainInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "sellProductItem",
    values: [string[]]
  ): string;
...
export interface RecycleChain extends BaseContract {
  ...
  addProduct: TypedContractMethod<
    [name: string, toxicNames: string[], toxicWeights: BigNumberish[]],
    [void],
    "nonpayable"
  >;
  ...
  sellProductItem: TypedContractMethod<
    [itemIds: string[]],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "sellProductItem"
  ): TypedContractMethod<[itemIds: string[]], [void], "nonpayable">;
